...
namespace Chat
{
    class Program
    {
        ...
        // уделенный хост и порты (удаленный и локальный)
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                // который блокирует текущий поток, поэтому необходим отдельный поток
            ...
            {
                Console.WriteLine("Преобразование невозможно: " + formEx.Message);
            }
            catch(Exception ex)
            {
