...
namespace WCF_BankService
{
    ...
    public class BankService : IBankService
    {
        ...
        [OperationBehavior(TransactionScopeRequired = true, TransactionAutoComplete = false)]			//второе изменение
        ...
        public void ToDeposit(double sum)
        {
            ...
            Console.WriteLine("Баланс: {0}  Transaction ID: {1}",bal, Transaction.Current.TransactionInformation.LocalIdentifier.ToString());
        }
