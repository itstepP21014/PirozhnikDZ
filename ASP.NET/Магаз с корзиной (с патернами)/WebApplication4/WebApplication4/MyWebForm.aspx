...
<body>
    ...
    <div>
        <div style="display: inline-block; margin-right: 20px">
            ...
            <asp:ListBox ID="ListBoxProducts" runat="server"  style="width: 200px" SelectionMode="Multiple" Rows="6"></asp:ListBox><br />
        ...
        <div style="display: inline-block">
            ...
            <asp:ListBox ID="ListBoxBusket" runat="server" style="width: 200px" SelectionMode="Multiple" Rows="6"></asp:ListBox><br />
