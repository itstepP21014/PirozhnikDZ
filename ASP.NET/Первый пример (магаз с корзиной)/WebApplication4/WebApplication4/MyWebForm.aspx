...
<body>
    ...
    <div>
        ...
        <div style="display: inline-block; margin-right: 20px">
            ...
            <asp:ListBox ID="ListBoxProducts" runat="server"  style="width: 200px" SelectionMode="Multiple" SelectedIndexChanged="ListBoxProducts_SelectedIndexChanged"></asp:ListBox><br />
        ...
        <div style="display: inline-block">
            ...
            <asp:ListBox ID="ListBoxBusket" runat="server" style="width: 200px" SelectionMode="Multiple" SelectedIndexChanged="ListBoxBusket_SelectedIndexChanged"></asp:ListBox><br />
