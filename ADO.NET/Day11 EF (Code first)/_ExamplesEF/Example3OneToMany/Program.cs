...
namespace Example3OneToMany
{
    class Program
    {
        ...
        {
            string ConnectionString = @"data source=(LocalDb)\v11.0;initial catalog=ExampleOneToMany.mdf;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework";
